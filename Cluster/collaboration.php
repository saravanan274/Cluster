                    ...
                    <div class="">
                        ...
                        <div class="row intro">
                            <div class="col-12">
                                ...
                                <h2 class="mb-0"><span class="featured"><span>Collaboration</span></span> </h2>
                            </div>
...
eVantage Technology recommends SharePoint Online, part of the Microsoft Office 365 suite, to give you a central place to share documents and information with colleagues and customers.</p>
                ...
                <div class="row justify-content-center items">
                    ...
                    <div data-aos="fade-up" class="col-12 col-md-6 item">
                        <div class="card">
                            <div class="col-12">
                            <svg style="width:45px; margin-bottom:20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M500.3 443.7l-119.7-119.7c27.22-40.41 40.65-90.9 33.46-144.7C401.8 87.79 326.8 13.32 235.2 1.723C99.01-15.51-15.51 99.01 1.724 235.2c11.6 91.64 86.08 166.7 177.6 178.9c53.8 7.189 104.3-6.236 144.7-33.46l119.7 119.7c15.62 15.62 40.95 15.62 56.57 0C515.9 484.7 515.9 459.3 500.3 443.7zM79.1 208c0-70.58 57.42-128 128-128s128 57.42 128 128c0 70.58-57.42 128-128 128S79.1 278.6 79.1 208z"/></svg>
                    ...
                    <div data-aos="fade-up" class="col-12 col-md-6 item">
                        <div class="card">
                            <div class="col-12">
                            <svg style="width:45px; margin-bottom:20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M224 0H160c-88.38 0-160 71.62-160 160v192c0 88.38 71.62 160 160 160h64c88.38 0 160-71.63 160-160V160C384 71.62 312.4 0 224 0zM224 159.1C224 177.6 209.6 192 192 192C174.4 192 160 177.6 160 159.1V127.1c0-17.62 14.38-32 32-32c17.62 0 32 14.38 32 32V159.1z"/></svg>
                                <p>Move easily from instant messaging into ad-hoc online meetings that include audio, video, and screen sharing with just a few mouse clicks.</p>
                                <i class="quote-right fas fa-quote-right"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-up" class="col-12 col-md-6 item">
                        <div class="card">
                            ...
                            <svg style="width:45px; margin-bottom:20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M488 191.1h-152l.0001 51.86c.0001 37.66-27.08 72-64.55 75.77c-43.09 4.333-79.45-29.42-79.45-71.63V126.4l-24.51 14.73C123.2 167.8 96.04 215.7 96.04 267.5L16.04 313.8c-15.25 8.751-20.63 28.38-11.75 43.63l80 138.6c8.875 15.25 28.5 20.5 43.75 11.75l103.4-59.75h136.6c35.25 0 64-28.75 64-64c26.51 0 48-21.49 48-48V288h8c13.25 0 24-10.75 24-24l.0001-48C512 202.7 501.3 191.1 488 191.1zM635.7 154.5l-79.95-138.6c-8.875-15.25-28.5-20.5-43.75-11.75l-103.4 59.75h-62.57c-37.85 0-74.93 10.61-107.1 30.63C229.7 100.4 224 110.6 224 121.6l-.0004 126.4c0 22.13 17.88 40 40 40c22.13 0 40-17.88 40-40V159.1h184c30.93 0 56 25.07 56 56v28.5l80-46.25C639.3 189.4 644.5 169.8 635.7 154.5z"/></svg>
                                <p>Invite external contacts to easily join online meetings through a native or web-based client.</p>
                                <i class="quote-right fas fa-quote-right"></i>
                            </div>
                        </div>
                    </div>
