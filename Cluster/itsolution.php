...
<html lang="en">
    ...
    <body class="home">
        ...
        <header id="header">
            ...
            <nav class="navbar navbar-expand top">
                <div class="container header">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link"><i class="fas fa-envelope mr-2"></i><span class="__cf_email__" data-cfemail="335b565f5f5c73564b525e435f561d505c5e">[email&#160;protected]</span></a>
                        </li>
                    </ul>
            ...
            <!-- Navbar -->
            <nav class="navbar navbar-expand navbar-fixed sub" style="background-color: black;">
                <div class="container header">

                    <!-- Navbar Brand-->
                    <a class="navbar-brand" href="#">
                        <span class="brand">
                           <img src ="assets/images/logo_thumb.png" alt ="CLUSTERUAE" width="200px" height="200px">
                        
                        <!-- 
                            Custom Logo
                            <img src="assets/images/logo.svg" alt="CLUSTERUAE">
                        -->
                    </a>
                    ...
                    <ul class="navbar-nav items">
                        ...
                        <li class="nav-item dropdown">
                            <a href="itservices.html" class="nav-link">IT SERVICES <i class="icon-arrow-down"></i></a>
                            <ul class="dropdown-menu">
                                <li class="nav-item dropdown"><a class="nav-link" href="#">Cloud Solutions</a>
                                </li>
                                <li class="nav-item"><a href="page-services-1.html" class="nav-link">IT Project Management</a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link" href="#">IT Security</a>
                                </li>
                                <li class="nav-item"><a href="page-projects-1.html" class="nav-link">IT Support Services</a></li>
                                <li class="nav-item"><a href="page-single-project-1.html" class="nav-link"> Smarts Hands Support Service</a></li>
                                <li class="nav-item"><a href="page-pricing-table-1.html" class="nav-link">Telephony</a></li>
                                <li class="nav-item"><a href="page-our-people-1.html" class="nav-link">Turnkey Office Fit out</a></li>
                            </ul>
                    </li>
                        <li class="nav-item dropdown">
                            <a href="menu/itsolution.html" class="nav-link"> IT SOLUTIONS <i class="icon-arrow-down"></i></a>
                            <ul class="dropdown-menu">
                                <li class="nav-item dropdown">
                                    <a class="nav-link" href="#"> Business Continuity & Disaster Recovery </a></li>
                                <li class="nav-item"><a href="page-single-post-1.html" class="nav-link">Business Continuity Management</a></li>
                                <li class="nav-item"><a href="page-projects-1.html" class="nav-link">Collaboration</a></li>
                                <li class="nav-item"><a href="page-single-project-1.html" class="nav-link"> Data Protection and Recovery</a></li>
                                <li class="nav-item"><a href="page-pricing-table-1.html" class="nav-link">Desktop as a Service (DaaS)</a></li>
                                <li class="nav-item"><a href="page-our-people-1.html" class="nav-link">Endpoint Monitoring and Management</a></li>
                                <li class="nav-item"><a href="page-projects-1.html" class="nav-link">Enterprise File Sync & Share</a></li>
                                <li class="nav-item"><a href="page-single-project-1.html" class="nav-link"> Infrastructure Design and Deployment</a></li>
                                <li class="nav-item"><a href="page-pricing-table-1.html" class="nav-link">Managed Security</a></li>
                                <li class="nav-item"><a href="page-our-people-1.html" class="nav-link">Managed Security</a></li>
                                <li class="nav-item"><a href="page-our-people-1.html" class="nav-link">Virtualization</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="menu/partnerproduct.html" class="nav-link">PARTNERS & PRODUCTS</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="menu/partnerproduct.html" class="nav-link">CLIENTS <i class="icon-arrow-down"></i></a>
                            <ul class="dropdown-menu">
                                <li class="nav-item dropdown">
                                <li class="nav-item"><a class="nav-link" href="#"> Testimonials </a></li>
                                <li class="nav-item"><a href="page-single-post-1.html" class="nav-link">Our Clients</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="menu/partnerproduct.html" class="nav-link">BLOG</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="menu/partnerproduct.html" class="nav-link">ABOUT US</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a href="menu/partnerproduct.html" class="nav-link">CONTACT US</a>
                        </li>
                    </ul>
        ...
        <!-- Services -->
        <section id="services" class="section-1 offers featured" style="margin-top: 30px;">
            <div class="container">
                <h1 style="text-align:center;">Our IT Solutions</h1>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        ...
                                        <span class="__cf_email__" data-cfemail="28404d444447684d50494558444d064b4745">[email&#160;protected]</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                        ...
                        <div class="col-12 col-lg-3 footer-left">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        <i class="fas fa-envelope mr-2"></i>
                                        <span class="__cf_email__" data-cfemail="e088858c8c8fa08598818d908c85ce838f8d">[email&#160;protected]</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
