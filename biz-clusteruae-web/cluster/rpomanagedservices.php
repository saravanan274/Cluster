            ...
            <div class="swiper-slide slide-center">
                ...
                <div class="slide-content row text-center">
                    <div class="col-12 mx-auto inner">
                        ...
                        <h1 class="mb-0 title effect-static-text">RPO & Managed Services</h1>
                    </div>
                </div>
            </div>
...
<div class="" style=" margin-left:200px;background-color:#eef4ed;padding:25px;">
    ...
    <p>cluster info tech works closely with our customers to build, organise and manage their contingent workforce. Our experts initiate a detailed evaluation of the existing contractor engagement model, review supplier services and margins and benchmark contractor rates..</p>
    ...
    <p>After implementation, cluster info tech mobilises an MSP delivery team that takes full responsibility for supplier and contractor management and works closely with our clients to drive continuous improvement</p>
</div>
